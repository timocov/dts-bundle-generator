	...
	entries: [
		{
			...
			output: {
				...
				declarationMap: schemaPrimitiveValues.boolean,
				declarationMapInlineSources: schemaPrimitiveValues.boolean,
				declarationMapSourceRoot: schemaPrimitiveValues.string,
			},
		},
	],
};
